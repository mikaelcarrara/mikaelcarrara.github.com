# Deplova — Pitch do Produto

Documento interno  
Audiência: fundadores, parceiros e colaboradores técnicos
...
Criar um MVP costuma demorar muito mais do que deveria.

Grande parte desse tempo é gasto antes mesmo do produto existir:

- escopo indefinido
- decisões técnicas repetidas
- reconstrução constante da mesma base

Enquanto isso, o aprendizado com usuários reais não acontece.

Cada semana sem produto é uma semana sem aprendizado.
...
Ao final do processo, o cliente recebe:

- um MVP funcional
- a aplicação deployada
- acesso ao repositório
- instruções básicas de operação

O objetivo não é um protótipo.

É **um produto real que já pode começar a receber usuários**.
